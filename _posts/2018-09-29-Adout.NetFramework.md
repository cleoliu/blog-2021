...
- NuGet 是一個用來安裝第三方套件的套件，舉例：
  ...
  - [System.Collections](https://www.nuget.org/packages/System.Collections) ：(主要為) 泛型集合的組合，包括 [List](https://docs.microsoft.com/zh-tw/dotnet/api/system.collections.generic.list-1)<T> 和 [Dictionary](https://docs.microsoft.com/zh-tw/dotnet/api/system.collections.generic.dictionary-2)<TKey,TValue>。
